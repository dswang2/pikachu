...
})({"gHq3e":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
const player = {
    ...
    bindEvents: ()=>{
        for(let key in player.events)if (player.events.hasOwnProperty(key)) // @ts-ignore
    ...
    ,
    step: ()=>{
        player.strFinal = player.strFinal + player.trans(_cssDefault.default[player.n]);
        player.ui.styleText.innerHTML = player.strFinal;
        player.ui.styleContent.innerHTML = _cssDefault.default.substring(0, player.n);
...
},{"./css":"4hgyY","@parcel/transformer-js/src/esmodule-helpers.js":"hrokx"}],"4hgyY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hrokx"}],"hrokx":[function(require,module,exports) {
...
},{}]},["gHq3e","1yGwE"], "1yGwE", "parcelRequire94c2")
